...
static int sum=0;
  public static void main(String[] args) {
    ...
    for (int i = 0; i < carsPerDay; i++) {
      System.out.println(
          "Please enter the brand of car, model, type of body, color, length, width, kg and price, separated by comma: ");
      Car car = new Car();
      ...
      double priceWithoutExtra = Double.parseDouble(carInfo.get(7));
      if ((i + 1) % 2 == 0) {
