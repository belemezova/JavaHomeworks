package bg.startit.java.oop.homework1.carFactory;
...
public class Car {
  ...
  public Car(String brand, String model, String body, String color, double length, double width, double kg, String engine, double price){
    this();
    setBrand(brand);
    setModel(model);
    setBody(body);
  ...
  public void setEngine(String engine) {
    if ((engine.equals("gasoline")) || (engine.equals("diesel"))|| (engine.equals("hybrid")) || (engine.equals("electric"))) {
      this.engine = engine;
    } else {
